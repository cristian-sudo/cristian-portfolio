...
const FunFacts: React.FC = () => {
    ...
    const contentData: { content: Record<string, { myFunFacts: FunFactsType }> } = data as any;
    const funFactsData: FunFactsType | undefined = contentData.content[language]?.myFunFacts;
